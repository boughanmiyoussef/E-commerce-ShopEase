...
const Footer = () => {
  return (
    <footer className="border-t py-12">
        ...
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 transition-all required"
            />
            <button
              type="submit"
      ...
      {/* Footer Bottom */}
      <div className="container mx-auto mt-12 px-4 lg:px-4 border-t border-gray-200 pt-6">
